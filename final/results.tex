...
To analyze the effects of changes to the particle distributions, we compared the update time of the octree after a perturbation is applied to the initial construction time for each initial distribution. It is clear that for the low particle workloads, perturbations have very little impact on update time as shown in Figure 8. Only for high particle workloads does the correlation of perturbation strength to relative update speed become significant, as shown in Figure \ref{fig:plot_100m}.
