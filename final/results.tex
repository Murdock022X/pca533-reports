...
For assessing the overall runtime of initial construction on qualitatively different distributions, there is a stark distinction of behavior between low particle count (1 million and less) and high particle count (10 million and more) workloads. The runtime of low particle workloads either is not correlated to the initial distribution. However, a consistent pattern emerges across high particle workloads, which is shown in Figure \ref{fig:gist_100m}. Here we can see that, generally, lower dimension distributions have lower construction cost associated with them. There is no consistently worst or best initial distribution as seen in figures \ref{fig:gist_100k} and \ref{fig:gist_100m}.
