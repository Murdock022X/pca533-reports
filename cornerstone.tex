...
We now come to the namesake of Cornerstone being the Cornerstone array called $K$. $K$ is an array of SFC keys of length $n_l+1$, $n_l$ being the number of leaves. 
