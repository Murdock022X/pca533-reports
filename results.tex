...
We used our framework to perform several experiments. We explored several questions for the midterm the first was parameter spaces we tests over different distributions, for both Morton and Hilbert keys, and the initial build versus the subsequent perturbation rebalance.
